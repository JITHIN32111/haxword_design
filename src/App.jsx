...
>
  ...
  <div className="relative z-20 pt-12 container mx-auto max-w-2xl px-4 text-center md:max-w-4xl md:px-6 lg:max-w-7xl">
    ...
    >
      ...
      >
        <motion.button
          className="relative w-full overflow-hidden rounded-full border border-red-500/30 bg-gradient-to-r from-red-600/20 via-red-700/20 to-red-800/20 backdrop-blur-sm px-8 py-4 text-white shadow-2xl shadow-red-500/20 transition-all duration-300 hover:border-red-400/50 hover:shadow-red-400/30 sm:w-auto"
          animate={{ opacity: 1, x: 0 }}
