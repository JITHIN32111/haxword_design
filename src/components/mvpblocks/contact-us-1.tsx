...
export default function ContactUs1() {
  ...
  return (
    <section className="bg-black relative w-full overflow-hidden py-16 md:py-24">
      <div
        className="absolute top-0 left-0 h-[500px] w-[500px] rounded-full opacity-20 blur-[120px] bg-red-500/30"
      />
      <div
        className="absolute right-0 bottom-0 h-[300px] w-[300px] rounded-full opacity-10 bg-red-600/20"
      />

      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="border-white/20 mx-auto max-w-5xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
          <div className="grid md:grid-cols-2">
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              >
                <h2 className="text-gray-300 mb-2 bg-gradient-to-r bg-clip-text text-4xl font-bold tracking-tight md:text-5xl">
                  Contact
                </h2>
                <span className="bg-gradient-to-r from-red-200 via-red-300 to-red-400 bg-clip-text text-lg font-bold text-transparent relative z-10 w-full text-4xl font-bold tracking-tight italic md:text-5xl">
                  Us
                </span>
                <SparklesCore
                  id="tsparticles"
              ...
              >
                ...
                >
                  <Button
                    ...
                    className="w-full bg-gradient-to-b from-red-800 via-red-900 to-red-950 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset] hover:from-red-700 hover:via-red-800 hover:to-red-900"
                  >
                    {isSubmitting ? (
            ...
            <motion.div
              ...
              className="relative hidden sm:flex my-20 items-center justify-center overflow-hidden pr-8"
            >
