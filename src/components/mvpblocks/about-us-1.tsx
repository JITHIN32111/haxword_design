  ...
  return (
    <section className="relative w-full overflow-hidden pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        >
          <h1 className="from-foreground/80 pt-6 font-medium tracking-tighter text-gray-300 via-foreground to-foreground/80 bg-gradient-to-r bg-clip-text text-4xl   sm:text-5xl md:text-6xl">
            {aboutData.title}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-red-100 via-red-200 to-red-300'>Story</span>
                      </h1>
        ...
        <div ref={missionRef} className="relative mx-auto mb-24 max-w-7xl">
          ...
          >
            ...
            >
              ...
              <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-red-500/20 to-blue-500/5 backdrop-blur-sm">
                <Rocket className="text-red-900 h-8 w-8" />
              </div>

              <div className="space-y-4">
                <h2 className="from-primary/90 text-gray-300 to-primary/70 mb-4 bg-gradient-to-r bg-clip-text text-3xl font-bold ">
                  Our Mission
                </h2>
            ...
            >
              ...
              <h2 className="mb-4 text-gray-300 text-3xl font-bold ">
                Our Vision
              </h2>
